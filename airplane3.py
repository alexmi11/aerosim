...
# https://www.youtube.com/watch?v=Rm_KoTBtVz4
...
def get_airplane_mass_props():
    return asb.MassProperties(mass=0.002, x_cg=0.005, y_cg = 0.0, z_cg = 0, Ixx=1.8e-06, Ixy=0, Ixz=0, Iyy=1.8e-06, Iyz=0, Izz=1.8e-06)
            ...
            asb.Wing(
                ...
                xsecs=[  # The wing's cross ("X") sections, or "XSecs"
                    ...
                    asb.WingXSec(  # Root
                        ...
                        chord=0.006,
                        twist=0,  # in degrees
                        airfoil=airfoil, # note the paper here: for AIRFOIL: https://www.fzt.haw-hamburg.de/pers/Scholz/arbeiten/TextDesenfans.pdf
